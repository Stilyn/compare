...
class InstrumentBlockReferent(Referent):
    ...
    def number(self) -> int:
        ...
        if (str0_ is None): 
            return 0
        i = 0
        wrapi1591 = RefOutArgWrapper(0)
        inoutres1592 = Utils.tryParseInt(str0_, wrapi1591)
        i = wrapi1591.value
        if (inoutres1592): 
            return i
        return 0
    ...
    def sub_number(self) -> int:
        ...
        if (str0_ is None): 
            return 0
        i = 0
        wrapi1593 = RefOutArgWrapper(0)
        inoutres1594 = Utils.tryParseInt(str0_, wrapi1593)
        i = wrapi1593.value
        if (inoutres1594): 
            return i
        return 0
    ...
    def sub_number2(self) -> int:
        ...
        inoutres1596 = Utils.tryParseInt(str0_, wrapi1595)
        i = wrapi1595.value
        if (inoutres1596): 
            return i
        return 0
