...
class MoneyReferent(Referent):
    ...
    def value(self) -> float:
        ...
        if (val is None): 
            return 0
        v = 0
        wrapv1757 = RefOutArgWrapper(0)
        inoutres1758 = Utils.tryParseFloat(val, wrapv1757)
        v = wrapv1757.value
        if (not inoutres1758): 
            return 0
        return v
    ...
    def alt_value(self) -> float:
        ...
        if (val is None): 
            return None
        v = 0
        wrapv1759 = RefOutArgWrapper(0)
        inoutres1760 = Utils.tryParseFloat(val, wrapv1759)
        v = wrapv1759.value
        if (not inoutres1760): 
            return None
        return v
    ...
    def rest(self) -> int:
        ...
        if (val is None): 
            return 0
        v = 0
        wrapv1761 = RefOutArgWrapper(0)
        inoutres1762 = Utils.tryParseInt(val, wrapv1761)
        v = wrapv1761.value
        if (not inoutres1762): 
            return 0
        return v
    ...
    def alt_rest(self) -> int:
        ...
        if (val is None): 
            return None
        v = 0
        wrapv1763 = RefOutArgWrapper(0)
        inoutres1764 = Utils.tryParseInt(val, wrapv1763)
        v = wrapv1763.value
        if (not inoutres1764): 
            return None
        return v
    ...
    @staticmethod
    def _new840(_arg1 : str, _arg2 : float) -> 'MoneyReferent':
        res = MoneyReferent()
        res.currency = _arg1
