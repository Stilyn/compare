...
class UnitextFootnote(UnitextItem):
    ...
    @staticmethod
    def _new93(_arg1 : str) -> 'UnitextFootnote':
        res = UnitextFootnote()
        res.custom_mark = _arg1
        return res
    
    @staticmethod
    def _new257(_arg1 : 'UnitextItem', _arg2 : bool) -> 'UnitextFootnote':
        res = UnitextFootnote()
        res.content = _arg1
    ...
    @staticmethod
    def _new302(_arg1 : 'UnitextItem') -> 'UnitextFootnote':
        res = UnitextFootnote()
        res.content = _arg1
        return res
    
    @staticmethod
    def _new418(_arg1 : 'UnitextItem', _arg2 : str) -> 'UnitextFootnote':
        res = UnitextFootnote()
        res.content = _arg1
    ...
    @staticmethod
    def _new420(_arg1 : bool, _arg2 : 'UnitextItem') -> 'UnitextFootnote':
        res = UnitextFootnote()
    ...
    @staticmethod
    def _static_ctor():
        UnitextFootnote.__m_footnotes_param = GetPlaintextParam._new507(True, " ", " ", " ", " ", " ")
        UnitextFootnote.__m_footnotes_param1 = GetPlaintextParam._new507(False, " ", " ", " ", " ", " ")
