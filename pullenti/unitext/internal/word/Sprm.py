...
class Sprm:
    ...
    def __str__(self) -> str:
        sprm_name = None
        wrapsprm_name450 = RefOutArgWrapper(None)
        inoutres451 = Utils.tryGetValue(SinglePropertyModifiers._map0_, self._sprm, wrapsprm_name450)
        sprm_name = wrapsprm_name450.value
        if (inoutres451): 
            return sprm_name
        else: 
