...
class HtmlParser:
    ...
    def parse(shtml : io.StringIO, preserve_whitespaces : bool=False) -> 'HtmlNode':
        ...
        first_pass540 = True
        while True:
            if first_pass540: first_pass540 = False
            else: i += 1
        ...
        first_pass541 = True
        while True:
            if first_pass541: first_pass541 = False
            else: i += 1
        ...
        first_pass542 = True
        while True:
            if first_pass542: first_pass542 = False
            else: i += 1
            if (not (i < len(items))): break
            pn = items[i]
            if (pn.tag_name == "BR"): 
        ...
        first_pass543 = True
        while True:
            if first_pass543: first_pass543 = False
            else: i += 1
            if (not (i < len(items))): break
            if (items[i]._printed): 
                continue
    ...
    def __create_node(list0_ : typing.List['HtmlParserNode'], ind_from : int, ind_to : int) -> 'HtmlNode':
        ...
        first_pass544 = True
        while True:
            if first_pass544: first_pass544 = False
            else: i += 1
