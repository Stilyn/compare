...
class MyZipFile(object):
    ...
    def __init__(self, file_name : str, content : bytearray) -> None:
        ...
        while True:
            ...
            self.__read_short()
            crc = self.__read_int()
            e0_.len0_ = self.__read_int()
            e0_.data_size = self.__read_int()
            ...
            self.__m_stream.position = self.__m_stream.position + (extr)
            e0_.pos = (self.__m_stream.position)
            self.__m_stream.position = self.__m_stream.position + (e0_.len0_)
            if (((flags & 8)) != 0 and e0_.len0_ == 0): 
    ...
    def unzip(self, e0_ : 'MyZipEntry') -> bytearray:
        ...
        if (e0_.method == 8 or e0_.method == 0): 
            ...
            return None
        buf = Utils.newArrayOfBytes(e0_.len0_, 0)
