...
class OdtHelper:
                        ...
                        if (Utils.getXmlLocalName(xx) == "master-page"): 
                            for xxx in xx: 
                                if (Utils.getXmlLocalName(xxx) == "header"): 
                                    ...
                                    doc.header = gg.finish(True, None)
                                elif (Utils.getXmlLocalName(xxx) == "footer"): 
                                    gg = UnitextGen()
                                    self.__read_gen0(xxx, gg, True, None, 0)
                                    doc.footer = gg.finish(True, None)
                            break
                    ...
                    for a in p.attrib.items(): 
                        if (Utils.getXmlAttrLocalName(a) == "column-width"): 
                            ...
                            if (vv.endswith("in")): 
                                vv = vv[0:0+len(vv) - 2]
                            d = 0
                            wrapd99 = RefOutArgWrapper(0)
                            inoutres100 = MiscHelper.try_parse_double(vv, wrapd99)
                            d = wrapd99.value
                            if (inoutres100): 
    ...
    def __read_list_style(self, xx : xml.etree.ElementTree.Element) -> None:
        ...
        if (nam is None): 
            return
        num = UnitextGenNumStyle._new101(nam)
    ...
    def __read_odt_num_style(self, num : 'UnitextGenNumStyle', xml0_ : xml.etree.ElementTree.Element) -> None:
        for x in xml0_: 
            if (Utils.getXmlLocalName(x) == "list-level-style-number"): 
                ...
                if (x.attrib is not None): 
                    for a in x.attrib.items(): 
                        if (Utils.getXmlAttrLocalName(a) == "num-suffix"): 
                            ...
                            wrapcou102 = RefOutArgWrapper(0)
                            Utils.tryParseInt(a[1], wrapcou102)
                            cou = wrapcou102.value
                        elif (Utils.getXmlAttrLocalName(a) == "start-value"): 
                            nn = 0
                            wrapnn103 = RefOutArgWrapper(0)
                            inoutres104 = Utils.tryParseInt(a[1], wrapnn103)
                            nn = wrapnn103.value
                            if (inoutres104): 
                                lev.start = nn
                if (frm == "1"): 
                ...
                lev = UniTextGenNumLevel._new105(UniTextGenNumType.BULLET)
                if (x.attrib is not None): 
                    for a in x.attrib.items(): 
        ...
        if (not pure and Utils.getXmlLocalName(xml0_) != "#text"): 
                ...
                if (xml0_.attrib is not None): 
                    for a in xml0_.attrib.items(): 
                        if (Utils.getXmlAttrLocalName(a) == "c"): 
                            cou = 0
                            wrapcou106 = RefOutArgWrapper(0)
                            inoutres107 = Utils.tryParseInt(Utils.ifNotNull(a[1], ""), wrapcou106)
                            cou = wrapcou106.value
                            if (inoutres107): 
                                while cou > 1: 
                                    gen.append_text(" ", False)
                                    cou -= 1
                    ...
                    if (Utils.getXmlLocalName(r) == "table-row"): 
                                ...
                                if (c.attrib is not None): 
                                    for a in c.attrib.items(): 
                                        if (Utils.getXmlAttrLocalName(a) == "number-rows-spanned"): 
                                            nn = 0
                                            wrapnn108 = RefOutArgWrapper(0)
                                            inoutres109 = Utils.tryParseInt(a[1], wrapnn108)
                                            nn = wrapnn108.value
                                            if (inoutres109): 
                                                cel.row_span = nn
                                ...
                                if (xml0_.attrib is not None): 
                                    for a in x.attrib.items(): 
                                        if (Utils.getXmlAttrLocalName(a) == "style-name"): 
                                            sty1 = None
                                            wrapsty1112 = RefOutArgWrapper(None)
                                            inoutres113 = Utils.tryGetValue(self.__m_styles, a[1], wrapsty1112)
                                            sty1 = wrapsty1112.value
                                            if (inoutres113): 
                        ...
                        if (r.attrib is not None): 
                            for a in r.attrib.items(): 
                                if (Utils.getXmlAttrLocalName(a) == "style-name"): 
                                    sty1 = None
                                    wrapsty1114 = RefOutArgWrapper(None)
                                    inoutres115 = Utils.tryGetValue(self.__m_styles, a[1], wrapsty1114)
                                    sty1 = wrapsty1114.value
                                    if (inoutres115): 
                                        if (sty1.table_column_width > 0): 
                                            colwi.append(sty1.table_column_width)
                                    break
            ...
            if (Utils.getXmlLocalName(xml0_) == "a"): 
                ...
                if (uri is not None): 
                    ...
                    if (it is not None): 
                        hr = UnitextHyperlink._new51(uri)
                        hr.children.append(it)
                ...
                if (xml0_.attrib is not None): 
                    for a in xml0_.attrib.items(): 
                        if (Utils.getXmlAttrLocalName(a) == "outline-level"): 
                            wrapout_line_level117 = RefOutArgWrapper(0)
                            Utils.tryParseInt(Utils.ifNotNull(a[1], ""), wrapout_line_level117)
                            out_line_level = wrapout_line_level117.value
                            ...
                            for kk in range(10):
                                if (sty1.num_style_id is not None): 
                                    wrapnum0118 = RefOutArgWrapper(None)
                                    Utils.tryGetValue(self.__m_nums, sty1.num_style_id, wrapnum0118)
                                    num0 = wrapnum0118.value
                                    break
                                if (sty1.parent_name is None): 
                                    break
                                wrapsty1119 = RefOutArgWrapper(None)
                                inoutres120 = Utils.tryGetValue(self.__m_styles, sty1.parent_name, wrapsty1119)
            ...
            if (out_line_level > 0 or num_sty is not None): 
                if (self.__m_outline_num is None and num_sty is None): 
                    ...
                    self.__m_outline_num.levels.append(UniTextGenNumLevel._new123(UniTextGenNumType.DECIMAL, "%1."))
                    self.__m_outline_num.levels.append(UniTextGenNumLevel._new123(UniTextGenNumType.DECIMAL, "%1.%2."))
                    self.__m_outline_num.levels.append(UniTextGenNumLevel._new123(UniTextGenNumType.DECIMAL, "%1.%2.%3."))
                    self.__m_outline_num.levels.append(UniTextGenNumLevel._new123(UniTextGenNumType.DECIMAL, "%1.%2.%3.%4."))
                    self.__m_outline_num.levels.append(UniTextGenNumLevel._new123(UniTextGenNumType.DECIMAL, "%1.%2.%3.%4.%5."))
                    self.__m_outline_num.levels.append(UniTextGenNumLevel._new123(UniTextGenNumType.DECIMAL, "%1.%2.%3.%4.%5.%6."))
                li = UnitextList._new55(out_line_level - 1)
                gg = UnitextGen()
                for x in xml0_: 
                    xml_stack.append(x)
            ...
            if (Utils.getXmlLocalName(xml0_) == "list"): 
                li = UnitextList._new55(num_level)
                num0 = None
                cont_num = False
                style_name = None
                if (xml0_.attrib is not None): 
                    for a in xml0_.attrib.items(): 
                        if (Utils.getXmlAttrLocalName(a) == "style-name"): 
                            sty1 = None
                            wrapsty1136 = RefOutArgWrapper(None)
                            inoutres137 = Utils.tryGetValue(self.__m_styles, a[1], wrapsty1136)
                            sty1 = wrapsty1136.value
                            if (inoutres137): 
                                if (sty1.num_style_id is not None): 
                                    wrapnum0131 = RefOutArgWrapper(None)
                                    style_name = sty1.num_style_id
                                    Utils.tryGetValue(self.__m_nums, style_name, wrapnum0131)
                                    num0 = wrapnum0131.value
                                elif (sty1.parent_name is not None): 
                                    sty2 = None
                                    wrapsty2133 = RefOutArgWrapper(None)
                                    inoutres134 = Utils.tryGetValue(self.__m_styles, sty1.parent_name, wrapsty2133)
                                    sty2 = wrapsty2133.value
                                    if (inoutres134): 
                                        if (sty2.num_style_id is not None): 
                                            wrapnum0132 = RefOutArgWrapper(None)
                                            style_name = sty2.num_style_id
                                            Utils.tryGetValue(self.__m_nums, style_name, wrapnum0132)
                                            num0 = wrapnum0132.value
                            else: 
                                wrapnum0135 = RefOutArgWrapper(None)
                                style_name = a[1]
                                Utils.tryGetValue(self.__m_nums, style_name, wrapnum0135)
                                num0 = wrapnum0135.value
                                if (style_name == "L9"): 
                                    pass
                ...
                if (num_style is None): 
                    ...
                    num_style.levels.append(UniTextGenNumLevel._new123(UniTextGenNumType.DECIMAL, "%1."))
                    num_style.levels.append(UniTextGenNumLevel._new123(UniTextGenNumType.DECIMAL, "%1.%2."))
                    num_style.levels.append(UniTextGenNumLevel._new123(UniTextGenNumType.DECIMAL, "%1.%2.%3."))
                    num_style.levels.append(UniTextGenNumLevel._new123(UniTextGenNumType.DECIMAL, "%1.%2.%3.%4."))
                    num_style.levels.append(UniTextGenNumLevel._new123(UniTextGenNumType.DECIMAL, "%1.%2.%3.%4.%5."))
                    num_style.levels.append(UniTextGenNumLevel._new123(UniTextGenNumType.DECIMAL, "%1.%2.%3.%4.%5.%6."))
                    num_level = 0
                        ...
                        if (x.attrib is not None): 
                            for a in x.attrib.items(): 
                                if (Utils.getXmlAttrLocalName(a) == "start-value"): 
                                    wrapn0144 = RefOutArgWrapper(0)
                                    Utils.tryParseInt(a[1], wrapn0144)
                                    n0 = wrapn0144.value
            ...
            if (xml0_.attrib is not None): 
                for a in xml0_.attrib.items(): 
                    if (Utils.getXmlAttrLocalName(a) == "style-name"): 
                        wrapsty147 = RefOutArgWrapper(None)
                        Utils.tryGetValue(self.__m_styles, a[1], wrapsty147)
                        sty = wrapsty147.value
                        if (a[1] == "T53"): 
                            pass
                        if (sty is not None and ((sty.is_super or sty.is_sub))): 
                            ...
                            if (len(tt) > 0 and (len(tt) < 100)): 
                                gen.append(UnitextPlaintext._new50(tt, (UnitextPlaintextType.SUB if sty.is_super else UnitextPlaintextType.SUP)), None, -1, False)
                                return
                        if (sty is not None and sty.is_wingdings): 
                            gg = UnitextGen()
                            xml_stack.append(xml0_)
                            self.__read_gen(xml_stack, gg, True, None, 0)
                            del xml_stack[len(xml_stack) - 1]
                            ...
                            tmp = io.StringIO()
                            it.get_plaintext(tmp, None)
                            tt = WingdingsHelper.get_unicode_string(Utils.toStringStringIO(tmp).strip())
                            if (len(tt) > 0): 
