...
class UnitextImage(UnitextItem):
    ...
    def get_html(self, res : io.StringIO, par : 'GetHtmlParam') -> None:
        ...
        if (self.content is None or len(self.content) > 10000000): 
    ...
    @staticmethod
    def _new89(_arg1 : str) -> 'UnitextImage':
        res = UnitextImage()
        res.id0_ = _arg1
        return res
    
    @staticmethod
    def _new250(_arg1 : bytearray) -> 'UnitextImage':
        res = UnitextImage()
        res.content = _arg1
        return res
    
    @staticmethod
    def _new325(_arg1 : bytearray, _arg2 : 'UnilayRectangle') -> 'UnitextImage':
        res = UnitextImage()
        res.content = _arg1
        res.rect = _arg2
        return res