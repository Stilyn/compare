...
class UnitextTablecell(UnitextItem):
    ...
    @staticmethod
    def _new72(_arg1 : int, _arg2 : int, _arg3 : int, _arg4 : int, _arg5 : object) -> 'UnitextTablecell':
        res = UnitextTablecell()
        res.col_begin = _arg1
        res.col_end = _arg2
        res.row_begin = _arg3
    ...
    @staticmethod
    def _new514(_arg1 : 'UnitextItem', _arg2 : int, _arg3 : int, _arg4 : int, _arg5 : int) -> 'UnitextTablecell':
        res = UnitextTablecell()
        res.content = _arg1
        res.col_begin = _arg2
        res.col_end = _arg3
    ...
    @staticmethod
    def _new518(_arg1 : bool, _arg2 : int, _arg3 : int, _arg4 : int, _arg5 : int) -> 'UnitextTablecell':
        res = UnitextTablecell()
        res.is_psevdo = _arg1
        res.col_begin = _arg2
        res.col_end = _arg3
