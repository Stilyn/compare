...
class AlgoParams:
    ...
    def _static_ctor():
        ...
        AlgoParams.PARAMS.append(AlgoParam._new2906("TransitiveCoef", 1, 4, 1))
        AlgoParams.PARAMS.append(AlgoParam._new2906("NextModel", 1, 4, 1))
        AlgoParams.PARAMS.append(AlgoParam._new2906("NgLink", 1, 3, 1))
        AlgoParams.PARAMS.append(AlgoParam._new2906("List", 1, 4, 1))
        AlgoParams.PARAMS.append(AlgoParam._new2906("VerbPlural", 1, 4, 1))
        AlgoParams.PARAMS.append(AlgoParam._new2906("CaseAccord", 1, 3, 1))
        AlgoParams.PARAMS.append(AlgoParam._new2906("MorphAccord", 1, 3, 1))
